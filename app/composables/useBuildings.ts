      ...
      rooms: [
        // R1 — Hijau
        {
          ...
          installations: [
            {
              id: "igd-7-r1-kb1",
              name: "Kompressor Hitachi Beta",
              type: "kompresor",
              status: "baik",
              lastMaintenance: "2026-04-10",
              lastReplacement: "2026-03-15",
              dailyCount: 1,
              monthlyCount: 24,
              posX: 8,
              posY: 12,
        ...
        // R2 — Kuning
        {
          ...
          installations: [
            ...
            {
              id: "igd-7-r2-kb1",
              name: "Kompresor Swan Beta",
              type: "kompresor",
              status: "baik",
              lastMaintenance: "2026-04-10",
              lastReplacement: "2026-03-20",
              dailyCount: 1,
              monthlyCount: 26,
              posX: 52,
              posY: 26,
            ...
            {
              id: "igd-7-r2-kb3",
              name: "Kompresor Hitachi Charlie",
              type: "kompresor",
              status: "baik",
              lastMaintenance: "2026-04-10",
              lastReplacement: null,
        ...
        // R3 — Biru
        {
          ...
          installations: [
            {
              id: "igd-7-r3-k1",
              name: "kompressor Swan Beta",
              type: "kompresor",
              status: "baik",
              lastMaintenance: "2026-04-10",
              lastReplacement: "2026-03-05",
              dailyCount: 1,
              monthlyCount: 24,
              posX: 38,
              posY: 12,
      ...
      rooms: [
        {
          ...
          installations: [
            {
              id: "igd-2-r1-vb1",
              name: "vakum Becker alfa",
              type: "vakum",
              status: "baik",
              lastMaintenance: "2026-04-11",
              lastReplacement: "2026-03-10",
              dailyCount: 1,
              monthlyCount: 28,
              posX: 5,
              posY: 14,
      ...
      rooms: [
        {
          ...
          installations: [
            {
              id: "nicu-4-r1-ac1",
              name: "kompressor atlas alfa",
              type: "kompresor",
              status: "baik",
              lastMaintenance: "2026-04-10",
              lastReplacement: "2026-02-15",
              dailyCount: 1,
              monthlyCount: 28,
              posX: 8,
              posY: 30,
      ...
      rooms: [
        {
          ...
          installations: [
            {
              id: "picu-1-r1-v2",
              name: "vakum mils alfa",
              type: "vakum",
              status: "baik",
              lastMaintenance: "2026-04-10",
              lastReplacement: "2026-03-18",
              dailyCount: 1,
              monthlyCount: 24,
              posX: 28,
              posY: 52,
...
export const useBuildings = () => {
  const getDynamicStatus = (
    name: string,
    defaultStatus: Installation["status"],
  ): Installation["status"] => {
    const alatStore = useAlatStore();
    const records = alatStore.dataAlat.filter((i) =>
      (i["Jenis Alat"] || "").toLowerCase().includes(name.toLowerCase()),
    );
  ...
  const getBuildingSummary = (buildingId: string): BuildingSummary => {
    ...
    const maintenanceDates = installations
      .map((i) => i.lastMaintenance)
      .sort()
      .reverse();
  ...
  const getInstallationRecords = (installationId: string) => {
    ...
    return alatStore.dataAlat
      ...
      .map((item, index) => ({
        id: index,
        date: item.Timestamp,
        type: (item["Jenis Pekerjaan"] || "").toLowerCase().includes("ganti")
          ? "penggantian"
          : "pemeliharaan",
        description:
          item[
        ...
        result: (item["Jenis Pekerjaan"] || "")
          .toLowerCase()
          .includes("pemeriksaan")
          ? "baik"
          : "penggantian_part",
